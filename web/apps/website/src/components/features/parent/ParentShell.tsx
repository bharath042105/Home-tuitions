...
import { CalendarCheck, GraduationCap, Search, User, Users } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/parent/search", label: "Find a tutor", icon: Search },
  { href: "/parent/bookings", label: "Bookings", icon: CalendarCheck },
  { href: "/parent/profile", label: "Profile", icon: User },
];

/**
 * Shell for parent-facing screens. Per Phase 1 IA, the full set is Dashboard/
 * Manage children/Search/My Bookings/Payments/Profile/Support - children
 * management/search (Phase 7) and Bookings (Phase 8) exist so far; Payments/
 * Support land with Phases 9-10.
 */
